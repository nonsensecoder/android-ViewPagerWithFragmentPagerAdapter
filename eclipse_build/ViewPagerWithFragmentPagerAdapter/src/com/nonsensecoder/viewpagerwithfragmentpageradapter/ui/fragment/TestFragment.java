package com.nonsensecoder.viewpagerwithfragmentpageradapter.ui.fragment;
...
public class TestFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			// fragment recreated from orientation change or activity recreated
			// by ActivityManager
			color = savedInstanceState.getString(ARG_COLOR);
			name = savedInstanceState.getString(ARG_NAME);
		} else {
			// for the first time , when fragment created, it should have
			// argument passed by newInstance(String name, String color)
